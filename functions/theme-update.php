...
/*
 * Menambahkan fungsi cek update tema
 * Sejak versi 1.0.1
 */
...
class ThemeUpdateChecker {
	public $theme = 'wp-masjid';              //The theme associated with this update checker instance.
	public $metadataUrl = 'http://new.wpmasjid.com/masjid.json';        //The URL of the theme's metadata file.
